...
![Hardware requirements](graphics/B05170_02_01.jpg)
...
![Hardware connections](graphics/B05170_02_02.jpg)

在下图中，我们可以看到带有传感器的电路:

![Hardware connections](graphics/B05170_02_03.jpg)
...
![Configuring the one-wire protocol](graphics/B05170_02_04.jpg)
...
![Displaying the readings on the screen](graphics/B05170_02_05.jpg)
...
2.  Select **Advanced Options,** as shown in the following screenshot:
    ...
    ![Connecting analog inputs using an MCP3008 ADC Converter](graphics/B05170_02_06.jpg)

3.  Enable **SPI** communication by selecting the **SPI** option:

    ![Connecting analog inputs using an MCP3008 ADC Converter](graphics/B05170_02_07.jpg)

4.  Select **<Yes>** to enable the SPI interface:

    ![Connecting analog inputs using an MCP3008 ADC Converter](graphics/B05170_02_08.jpg)

5.  The final screen looks like the following screenshot when we enable the SPI interface. Select **<Ok>**:

    ![Connecting analog inputs using an MCP3008 ADC Converter](graphics/B05170_02_09.jpg)

# 树莓皮 GPIO 头

下面的截图是树莓 Pi Zero 的 GPIO 引脚的图表。在这种情况下，我们将使用 SPI 配置接口(`SPI_MOSI, SPI_MISO, SPI_CLK, SPI_CE0_N`):

![Raspberry Pi GPIO header](graphics/B05170_02_10.jpg)

下图显示了连接到树莓 Pi 的 MCP3008 芯片的引脚名称:

![Raspberry Pi GPIO header](graphics/B05170_02_11.jpg)

下图显示了温度传感器:

![Raspberry Pi GPIO header](graphics/B05170_02_12.jpg)
...
![Raspberry Pi GPIO header](graphics/B05170_02_13.jpg)

下图显示了传感器与模数转换器 MCP3008 和树莓 Pi 的连接:

![Raspberry Pi GPIO header](graphics/B05170_02_14.jpg)
...
12.  On the following screen, we can see the temperature, the ADC measurements, and the volts according to the temperature:
    ...
    ![Reading the data with a Python script](graphics/B05170_02_15.jpg)
...
1.  Select **Advanced Options**:
    ...
    ![I2C setup](graphics/B05170_02_16.jpg)

2.  Enable the **I2C** option, as shown in the following screenshot:

    ![I2C setup](graphics/B05170_02_17.jpg)

3.  Select **<Yes>** on the next screen:

    ![I2C setup](graphics/B05170_02_18.jpg)

4.  Select **<Ok>**:

    ![I2C setup](graphics/B05170_02_19.jpg)

5.  Then select **<Yes>**:

    ![I2C setup](graphics/B05170_02_20.jpg)

6.  Next, select **<OK>**:

    ![I2C setup](graphics/B05170_02_21.jpg)
...
![Hardware setup](graphics/B05170_02_22.jpg)

下图显示了电路连接:

![Hardware setup](graphics/B05170_02_23.jpg)

下图显示了最终连接:

![Hardware setup](graphics/B05170_02_24.jpg)
...
![Testing the RTC](graphics/B05170_02_25.jpg)
...
![I2C device setup](graphics/B05170_02_26.jpg)
...
![Putting the real-time clock to final test](graphics/image_02_027.jpg)
...
![Putting the real-time clock to final test](graphics/image_02_028.jpg)
