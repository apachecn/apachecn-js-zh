...
![Query for recording temperature](graphics/B05170_06_23.jpg)
...
现在终于到了测试我们应用程序的时候了！首先，从这本书的存储库中获取所有代码，并像以前一样导航到项目的文件夹。然后，用以下命令安装`express`:
...
下面是这个应用程序的代码，它使用网页中的界面来控制 DC 电机:
