...
![Creating our first application](graphics/B05170_08_01.jpg)

转到菜单**项目**和**开始新项目**:

![Creating our first application](graphics/B05170_08_02.jpg)

写下项目的名称:

![Creating our first application](graphics/B05170_08_03.jpg)

在下面的截图中，我们把我们项目的名字写成 **aREST** :

![Creating our first application](graphics/B05170_08_04.jpg)

按下**确定**，我们将看到创建的项目:

![Creating our first application](graphics/B05170_08_05.jpg)

## 设计界面

现在是时候看看如何创建应用程序的界面了，在我们创建项目之后，我们点击项目的名称，然后我们会看到下面的屏幕:

![Designing the interface](graphics/B05170_08_06.jpg)

在我们左侧的用户界面中(你可以看到所有的对象)，要将一个对象移动到主屏幕，你只需拖动**网页查看器**和**按钮**，如下图所示:

![Designing the interface](graphics/B05170_08_07.jpg)
...
![Communicating APP Inventor with Arduino ethernet shield](graphics/B05170_08_08a.jpg)
...
![Code for APP Inventor](graphics/B05170_08_09.jpg)

当我们打开网络浏览器时，我们将得到以下结果:

![Code for APP Inventor](graphics/B05170_08_10.jpg)

下面的截图显示了手机上运行的应用程序:

![Code for APP Inventor](graphics/B05170_08_11.jpg)

下图显示了连接的最终结果:

![Code for APP Inventor](graphics/B05170_08_12.jpg)
...
![Reading JSON response in Android Studio using ethernet shield](graphics/B05170_08_13.jpg)

然后我们选择我们想要使用的应用编程接口版本，点击**下一步**按钮:

![Reading JSON response in Android Studio using ethernet shield](graphics/B05170_08_14.jpg)

然后选择一个**空白活动**，点击**下一步**按钮:

![Reading JSON response in Android Studio using ethernet shield](graphics/B05170_08_15.jpg)

键入您的活动名称和布局，然后单击**完成**按钮:

![Reading JSON response in Android Studio using ethernet shield](graphics/B05170_08_16.jpg)
...
![Permission of the application](graphics/B05170_08_17.jpg)

`humidity`的值:

![Permission of the application](graphics/B05170_08_18.jpg)
...
![Hardware requirements](graphics/B05170_08_19.jpg)

下图显示了电路与 Arduino 电路板的最终连接:

![Hardware requirements](graphics/B05170_08_20.jpg)

最终界面如下图所示:

![Hardware requirements](graphics/B05170_08_21.jpg)

下图显示了连接的最终结果:

![Hardware requirements](graphics/B05170_08_22.jpg)
...
2.  `http://192.168.1.111:8099/ledoff`
    ...
    ![Controlling outputs from android using your Raspberry Pi Zero](graphics/B05170_08_23.jpg)

在 APP Inventor 中创建的界面将类似于以下截图:

![Controlling outputs from android using your Raspberry Pi Zero](graphics/B05170_08_24.jpg)

最终的电路连接如下图所示:

![Controlling outputs from android using your Raspberry Pi Zero](graphics/B05170_08_25.jpg)
...
![Controlling outputs with Raspberry Pi via Bluetooth](graphics/B05170_08_26.jpg)

## 从安卓应用程序控制灯光

我们需要下载蓝牙终端，如下图截图所示:

![Controlling lights from an Android Application](graphics/B05170_08_27.jpg)

以下屏幕截图显示了发送数字 1、2、3、4、5 和 6 的结果:

![Controlling lights from an Android Application](graphics/B05170_08_28.jpg)

下图显示了项目的最后部分以及与 HC05 模块和树莓 Pi Zero 的连接:

![Controlling lights from an Android Application](graphics/B05170_08_29.jpg)
