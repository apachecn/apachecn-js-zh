...
![Downloading a sketch from the graphical interface](graphics/B05170_05_06.jpg)

我们应该在界面下载草图。下图为连接的 Arduino-rubber Pi:太酷了！

![Downloading a sketch from the graphical interface](graphics/image_05_007.jpg)
...
![Hardware connections](graphics/B05170_05_08.jpg)
...
![Connecting a TTL serial camera to Arduino and saving pictures to a micro SD](graphics/image_05_009.jpg)
...
![Code for Python scripts](graphics/B05170_05_10.jpg)
...
![Configuring Arduino YUN](graphics/B05170_05_11-1.jpg)
...
![Configuring Arduino YUN](graphics/B05170_05_12-1.jpg)
...
![Monitoring from the MJPG-STREAMER server](graphics/B05170_05_13.jpg)
...
![Monitoring the USB camera from the Raspberry Pi](graphics/B05170_05_14.jpg)

在下一节中，我们将了解如何配置连接的设备和将在网络中交互的硬件。

下图表示我们使用可监控的设备创建的网络；例如，我们监控一所房子的每个房间，用无线网络连接所有设备，并从树莓皮监控它们:

![Monitoring the USB camera from the Raspberry Pi](graphics/image_05_015.jpg)
