...
![Requirements for AJAX](Images/6034OS_04_01.jpg)
...
![Requirements for AJAX](Images/6034OS_04_02.jpg)
...
![Requirements for AJAX](Images/6034OS_04_03.jpg)
...
![Requirements for AJAX](Images/6034OS_04_04.jpg)
...
![Hosting JSON](Images/6034OS_04_06.jpg)
...
![Making your first AJAX call](Images/6034OS_04_09.jpg)

我们将从加载外部 JavaScript 文件的基本`index.html`文件开始。这个 JavaScript 文件执行 AJAX 调用来获取`students` JSON 提要。

让我们来看看`index.js`:

![Making your first AJAX call](Images/6034OS_04_10.jpg)

这是对实时 web 服务器进行 AJAX 调用的原始方式；让我们把这个脚本分成几部分，一点一点地研究它:

![Making your first AJAX call](Images/6034OS_04_11.jpg)
...
![Making your first AJAX call](Images/6034OS_04_12.jpg)
...
![Making your first AJAX call](Images/6034OS_04_13.jpg)
...
![Making your first AJAX call](Images/6034OS_04_14.jpg)

在我们的`onreadystateChange` 回调中，我们记录了 web 服务器发送到控制台窗口的响应。让我们快速了解一下响应是什么样的:

![Making your first AJAX call](Images/6034OS_04_15.jpg)
...
![Making your first AJAX call](Images/6034OS_04_16.jpg)
...
![Parsing JSON data](Images/6034OS_04_17.jpg)
...
![Parsing JSON data](Images/6034OS_04_18.jpg)

在加载文档时，因为我们只是将事件绑定到 HTML 元素，所以除非我们点击按钮，否则不会有任何行为变化。一旦我们点击按钮，无序列表将被填充。

![Parsing JSON data](Images/6034OS_04_19.jpg)
