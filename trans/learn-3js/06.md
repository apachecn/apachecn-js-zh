...
![THREE.ConvexGeometry](graphics/2215OS_06_01.jpg)
...
![THREE.LatheGeometry](graphics/2215OS_06_02.jpg)
...
![THREE.ExtrudeGeometry](graphics/2215OS_06_03.jpg)
...
![THREE.TubeGeometry](graphics/2215OS_06_04.jpg)
...
![Extrude from SVG](graphics/2215OS_06_05.jpg)
...
![THREE.ParametricGeometry](graphics/2215OS_06_06.jpg)
...
![Rendering text](graphics/2215OS_06_07.jpg)
...
包含在三个. js 中的字体也被添加到本书的源代码中。你可以在`assets/fonts`文件夹中找到它们。
...
![Adding custom fonts](graphics/2215OS_06_08.jpg)
...
![Using binary operations to combine meshes](graphics/2215OS_06_09.jpg)
...
![The subtract function](graphics/2215OS_06_10.jpg)
...
![The subtract function](graphics/2215OS_06_11.jpg)

在本示例中，首先执行为**球体 2** 定义的动作，然后执行为**立方体**定义的动作。因此，如果我们减去**球体 2** 和**立方体**(我们沿着 *x* 轴缩放一点)，我们会得到以下结果:

![The subtract function](graphics/2215OS_06_12.jpg)
...
![The intersect function](graphics/2215OS_06_13.jpg)
...
![The intersect function](graphics/2215OS_06_14.jpg)
...
![The union function](graphics/2215OS_06_15.jpg)
