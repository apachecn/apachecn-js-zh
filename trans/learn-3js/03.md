...
![THREE.AmbientLight](graphics/2215OS_03_01.jpg)
...
![THREE.AmbientLight](graphics/2215OS_03_02.jpg)
...
![Using the THREE.Color object](graphics/2215OS_03_03.jpg)
...
![THREE.PointLight](graphics/2215OS_03_04.jpg)

在本例中，`THREE.PointLight`在我们已经在[第 1 章](01.html "Chapter 1. Creating Your First 3D Scene with Three.js")、*中看到的场景中移动，使用三个 js* 创建您的第一个 3D 场景。为了更清楚`THREE.PointLight`在哪里，我们沿着相同的路径移动一个小的橙色球体。当这种光四处移动时，你会看到红色立方体和蓝色球体在不同的侧面被这种光照亮。
...
![THREE.PointLight](graphics/2215OS_03_05.jpg)
...
![THREE.PointLight](graphics/2215OS_03_06.jpg)
...
| `shadowCameraFov` | 这个决定了用于创建阴影的视场有多大(参见[第 2 章](02.html "Chapter 2. Basic Components That Make Up a Three.js Scene")、*组成三个 js 场景的基本组件*中的*不同用途的不同相机*部分)。默认值为`50`。 |
...
![THREE.SpotLight](graphics/2215OS_03_07.jpg)
...
![THREE.SpotLight](graphics/2215OS_03_08.jpg)
...
![THREE.SpotLight](graphics/2215OS_03_09.jpg)
...
![THREE.SpotLight](graphics/2215OS_03_10.jpg)
...
![THREE.DirectionalLight](graphics/2215OS_03_11.jpg)
...
![THREE.DirectionalLight](graphics/2215OS_03_12.jpg)
...
![THREE.HemisphereLight](graphics/2215OS_03_13.jpg)
...
![THREE.AreaLight](graphics/2215OS_03_14.jpg)
...
![THREE.AreaLight](graphics/2215OS_03_15.jpg)
...
![LensFlare](graphics/2215OS_03_16.jpg)
...
![LensFlare](graphics/2215OS_03_17.jpg)
...
![LensFlare](graphics/2215OS_03_18.jpg)
...
![LensFlare](graphics/2215OS_03_19.jpg)
