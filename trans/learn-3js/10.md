...
![Loading a texture and applying it to a mesh](graphics/2215OS_10_01.jpg)
...
![Loading a texture and applying it to a mesh](graphics/2215OS_10_02.jpg)
...
![Using a bump map to create wrinkles](graphics/2215OS_10_03.jpg)
...
![Using a bump map to create wrinkles](graphics/2215OS_10_04.jpg)
...
![Achieving more detailed bumps and wrinkles with a normal map](graphics/2215OS_10_05.jpg)
...
![Achieving more detailed bumps and wrinkles with a normal map](graphics/2215OS_10_06.jpg)
...
![Creating fake shadows using a light map](graphics/2215OS_10_07.jpg)

如果你看一下前面的例子，它显示了两个非常好的阴影，似乎是由两个立方体投射的。然而，这些阴影是基于如下所示的光照贴图纹理:

![Creating fake shadows using a light map](graphics/2215OS_10_08.jpg)
...
![Creating fake reflections using an environment map](graphics/2215OS_10_09.jpg)
...
![Creating fake reflections using an environment map](graphics/2215OS_10_10.jpg)
...
![Creating fake reflections using an environment map](graphics/2215OS_10_22.jpg)
...
![Custom UV mapping](graphics/2215OS_10_13.jpg)
...
![Custom UV mapping](graphics/2215OS_10_14.jpg)

这是搅拌机中立方体的默认设置。让我们通过仅选择纹理的三分之二来更改 UV(参见下面截图中的选定区域):

![Custom UV mapping](graphics/2215OS_10_15.jpg)

如果我们现在在 Three.js 中显示这个，可以看到纹理的应用是不同的，如下图截图所示:

![Custom UV mapping](graphics/2215OS_10_16.jpg)
...
![Custom UV mapping](graphics/2215OS_10_23.jpg)
...
![Repeat wrapping](graphics/2215OS_10_17.jpg)
...
![Repeat wrapping](graphics/2215OS_10_18.jpg)
...
![Using the canvas as a texture](graphics/2215OS_10_19.jpg)
...
![Using the canvas as a bump map](graphics/2215OS_10_20.jpg)
...
![Using the output from a video as a texture](graphics/2215OS_10_21.jpg)
