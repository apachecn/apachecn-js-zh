...
![Matching a complete name](graphics/2258OS_04_01.jpg)
...
![Using the String.replace method](graphics/2258OS_04_02.jpg)

如果您查看前面代码的控制台输出，您应该会得到类似如下的结果:

![Using the String.replace method](graphics/2258OS_04_03.jpg)
