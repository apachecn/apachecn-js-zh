...
| 朱莉三维克莉丝汤姆(男子名)克拉罗红电的带电的好吧土坯砖海藻巴哈马蓝色黄昏 | 沙漠与众不同的美元蝗虫草原灰色的天空和谐愤怒爱尔兰MiamiNice中西部有薄荷味的紫色雨 | CubanShirts皇家紫SageToLime 石灰蘑菇凝灰岩WatersEdge湿地PlotKit.bluePlotKit .青色PlotKit.greenPlotKit.orangePlotKit .紫色PlotKit.red |
...
![Dojo chart themes](graphics/B04959_08_01.jpg)
...
![Charting using the popup template](graphics/B04959_08_02.jpg)
...
![Chart plugins](graphics/B04959_08_03.jpg)

弹出窗口中的第二个标签显示了道场图。图表中有一个图例元素。当我们将鼠标悬停在饼图中的任何数据上时，它会被切片、放大一点并突出显示。

![Chart plugins](graphics/B04959_08_04.jpg)

# 用 D3.js 绘制图表

D3.js 是一个用于基于数据操作文档的 JavaScript 库。D3 代表数据驱动的文档，该库提供了强大的可视化组件和数据驱动的 DOM 操作方法。

要在我们的 JavaScript 应用程序中使用 D3，我们可以从位于[http://d3js.org/](http://d3js.org/)的 D#网站下载该库。
...
![Creating a column chart with D3](graphics/B04959_08_05.jpg)
...
![D3 data](graphics/B04959_08_06.jpg)
...
![Integrating SVG into D3 charts](graphics/B04959_08_07.jpg)
...
![Integrating SVG into D3 charts](graphics/B04959_08_08.jpg)

在下面的截图中，我们选择了一个家庭收入中位数最少的县。请注意 *Y* 轴如何根据数据的最大值重新校准自己。

![Integrating SVG into D3 charts](graphics/B04959_08_09.jpg)
...
`dojo`包期望在`/js/cedar`位置有一组雪松库文件。我们可以从位于[https://github.com/Esri/cedar/tree/develop/src](https://github.com/Esri/cedar/tree/develop/src)的github 资源库下载所需文件。

我们需要在前面提到的网址找到的所有文件。将这些文件放在应用程序的`/js/cedar`文件夹中。

![Loading using the AMD pattern](graphics/B04959_08_10.jpg)
...
![Loading using the AMD pattern](graphics/B04959_08_11.jpg)
...
![Loading using the AMD pattern](graphics/B04959_08_12.jpg)
...
![Loading using the AMD pattern](graphics/B04959_08_13.jpg)
