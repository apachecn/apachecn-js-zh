...
![Setting up Node in Visual Studio](Image00033.jpg)
...
![Chaining asynchronous functions](Image00034.jpg)
...
首先，让我们创建一个简单的基于 TypeScript 的解决方案，使用带有 TypeScript 的“ **Html 应用程序”** Visual Studio 模板。如果您没有使用 Visual Studio，那么只需创建一个新的项目或基础源目录，并为 TypeScript 编译设置您的环境。要使用 AMD 编译，我们需要设置我们的 TypeScript 项目属性，以便编译为 AMD 模块语法。
...
![Creating an application](Image00036.jpg)
...
![Using jQuery plugins](Image00037.jpg)
...
![Using jQuery plugins](Image00038.jpg)
