...
![The problem space](Image00039.jpg)
...
如果我们仔细看看这个层次结构，很容易想象在一个大型应用程序中，我们会有大量的集合、模型、视图和项目视图。可能是我们正在加载集合的集合，以及包含子视图的视图，这些子视图包含更多的子视图。为了使用我们的模板机制，这些视图中的每一个都需要通过文本插件加载一些 HTML。

让我们仔细看看我们在前面的例子中是如何加载和使用一个 HTML 片段的:

![The problem space](Image00040.jpg)
...
![Creating a Service](Image00041.jpg)
...
![Using the Service Locator](Image00042.jpg)
...
![Using the Service Locator](Image00043.jpg)
...
![Multiple Event Handlers](Image00045.jpg)
...
![Displaying error notifications](Image00046.jpg)
