...
这是描述函数的类型脚本定义。首先`declare function describe`告诉我们可以使用一个叫做`describe`的函数，但是这个函数的实现会在运行时提供。
...
![Creating a Visual Studio Project](Image00001.jpg)
...
如果我们现在编译然后运行这个项目，我们将马上有一个完整的、正在运行的 TypeScript 应用程序:

![Default project settings](Image00002.jpg)
...
`app.js`文件不包含在**解决方案资源管理器**中–仅包含`app.ts`类型脚本文件。这是设计好的。如果您希望看到生成的 JavaScript 文件，只需点击**解决方案浏览器**工具栏中的**显示所有文件**按钮。
...
![Debugging in Visual Studio](Image00003.jpg)
...
![Debugging in Visual Studio](Image00004.jpg)
...
![Creating a WebStorm project](Image00005.jpg)

“创建新项目”对话框

然后，网络风暴会要求你选择你打算开发的推特助推器版本。在这个例子中，我们选择了版本`v3.2.0`。

![Creating a WebStorm project](Image00006.jpg)
...
![Default files](Image00007.jpg)

首次显示文件观察器栏编辑一个类型脚本文件
...
![Running the web page in Chrome](Image00009.jpg)
...
![Debugging in Chrome](Image00010.jpg)
...
![Installing Brackets](Image00011.jpg)
...
![Using Brackets live preview](Image00012.jpg)
...
![Creating a TypeScript file](Image00013.jpg)
...
![Compiling our TypeScript](Image00014.jpg)
...
![Debugging in Chrome](Image00015.jpg)
