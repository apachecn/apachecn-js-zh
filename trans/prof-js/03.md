...
![Figure 3.1: Output of the console.table function ](Images/C14587_03_01.jpg)
...
![Figure 3.4: Statistics of the files found ](Images/C14587_03_04.jpg)

###### 图 3.4:找到的文件的统计信息

你可以从父目录开始执行搜索:

![Figure 3.5: Executing the search in the parent directory ](Images/C14587_03_05.jpg)
...
![Figure 3.6: On the thread-per-request model, threads sleep while the I/O and other blocking operations happen ](Images/C14587_03_06.jpg)
...
![Figure 3.8: Asynchronous model with an event loop ](Images/C14587_03_08.jpg)
...
![Figure 3.9: Hello world web server example response ](Images/C14587_03_09.jpg)

###### 图 3.9:Hello world web 服务器示例响应

您可以尝试到达其他路径，例如`http://localhost:3000/index.html`。 结果是一样的:

![Figure 3.10: Hello world server always responds with Hello world ](Images/C14587_03_10.jpg)
...
![Figure 3.11: Static index.js served from our HTTP server as viewed from the browser ](Images/C14587_03_11.jpg)
...
![Figure 3.12: The server responds with a 404 error when asked for a file that doesn't exist ](Images/C14587_03_12.jpg)
...
![Figure 3.13: Storefront served from the dynamic web server ](Images/C14587_03_13.jpg)
...
![Figure 3.14: The user downloads content, types data in, submits it, and then wait for the results ](Images/C14587_03_14.jpg)
...
![Figure 3.15: Robot executing the task automatically by downloading content and making decisions based on an algorithm ](Images/C14587_03_15.jpg)
...
![Figure 3.16: The basic scraping technique involves downloading and processing the base HTML file ](Images/C14587_03_16.jpg)
...
![Figure 3.17: Depending on the use case, scraping requires a simulated or a fully headless browser to download and render the page more accurately ](Images/C14587_03_17.jpg)
...
7.  Filter the anchors based on the fact that Medium article paths have two parts: `/author/articleId`. This means we can parse the `href` of the anchor as a URL, get the pathname, split using "/" as a separator, and ignore anyone that doesn't have exactly two parts:
    ...
    ![Figure 3.18: The next sibling of the parent contains a short description of the article ](Images/C14587_03_18.jpg)
...
![Figure 3.19: Article printed to the console after running the application  ](Images/C14587_03_19.jpg)
