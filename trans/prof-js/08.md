...
5.  Call the `run Request` function:
    ...
    ![Figure 8.1: Output of runRequest ](Images/C14587_08_01.jpg)
...
6.  Modify the `runRequest` function to call `getCart` as well:
    ...
    ![Figure 8.2: Output after modifying the runRequest function ](Images/C14587_08_02.jpg)
...
7.  Modify the preceding function to output the cart of the first user:
    ...
    ![Figure 8.3: Output of the cart for the first user ](Images/C14587_08_03.jpg)
...
8.  Trigger an error when accessing the cart of an unknown user:
    ...
    ![Figure 8.4: Printing the error ](Images/C14587_08_04.jpg)
...
![Figure 8.5: Table with sample operations and their classification ](Images/C14587_08_05.jpg)
...
![Figure 8.6: Event loop cycle ](Images/C14587_08_06.jpg)
...
![Figure 8.7: Output after the timeout is complete ](Images/C14587_08_07.jpg)
...
6.  Invoke the `calculate` function using an ID that does not exist to check the resulting error.
    ...
    ![Figure 8.8: Invoking a function using an ID that doesn’t exist ](Images/C14587_08_08.jpg)
...
2.  Add an operation to the resolver function:
    ...
    ![Figure 8.9: Adding an operation in the resolver function ](Images/C14587_08_09.jpg)
...
3.  Resolve the promise using `resolve`:
    ...
    ![Figure 8.10: Resolved promise after the function is called ](Images/C14587_08_10.jpg)
...
4.  Retrieve the value using the `then()` function. By attaching a `then` handler, you are expected to read the resolved promise value from the callback:
    ...
    ![Figure 8.11: Retrieving the value using the then function ](Images/C14587_08_11.jpg)
...
6.  Create an immediately rejected promise:
    ...
    ![Figure 8.12: Immediately rejected promise creation ](Images/C14587_08_12.jpg)
...
7.  Handle `error` in the promise using `catch`:
    ...
    ![Figure 8.13: Handling an error in a promise using catch ](Images/C14587_08_13.jpg)
...
9.  Use an `async` function to delay our console log:
    ...
    ![Figure 8.14: Delaying the console log using an async function ](Images/C14587_08_14.jpg)
...
10.  Chain the promises using the `then` function:
    ...
    ![Figure 8.15: Promises chained using the then function ](Images/C14587_08_15.jpg)
...
![Figure 8.16: Example pipeline (a collection of operations) ](Images/C14587_08_16.jpg)
...
4.  Call the function we declared before, in `getFullRecord`, and return the combined result from `getProfile`, `getCart`, and `getSubscription`:
    ...
    ![Figure 8.17: Calling the declared function in getFullRecord ](Images/C14587_08_17.jpg)
...
7.  Update the `getFullRecord` function:
    ...
    ![Figure 8.18: Updated getFullRecord function ](Images/C14587_08_18.jpg)
...
![Figure 8.19: Testing the getFullRecords function ](Images/C14587_08_19.jpg)
...
![Figure 8.20: Executing the getFullRecords function ](Images/C14587_08_20.jpg)
...
![Figure 8.21: Error when running the getProfile function ](Images/C14587_08_21.jpg)
...
8.  Call `calculate` on one of our users:
    ...
    ![Figure 8.22: Calling calculate on one of our users ](Images/C14587_08_22.jpg)
...
9.  Call the `calculateAll` function:
    ...
    ![Figure 8.23: Calling the calculateAll function ](Images/C14587_08_23.jpg)
...
![Figure 8.24: Getting the value of the returned promise ](Images/C14587_08_24.jpg)
...
![Figure 8.25: Calling the printHello function ](Images/C14587_08_25.jpg)
...
2.  Call the function and use `await`:
    ...
    ![Figure 8.26: Calling the function using await ](Images/C14587_08_26.jpg)
...
3.  Modify the statement and wrap it in an `async` function:
    ...
    ![Figure 8.27: Modifying the statement and wrapping it in an async function ](Images/C14587_08_27.jpg)
...
4.  Call the `then()` function with a handler of the `async` function:
    ...
    ![Figure 8.28: Calling the then function with a handler of the async function ](Images/C14587_08_28.jpg)
...
6.  Modify `printList` to include the price from `getPrice`:
    ...
    ![Figure 8.29: Modifying printList to include the price from getPrice ](Images/C14587_08_29.jpg)
...
8.  Call `buggyCode` in `printList`:
    ...
    ![Figure 8.30: Calling buggyCode in printList ](Images/C14587_08_30.jpg)
...
9.  Use a `catch` handler on `buggyCode`:
    ...
    ![Figure 8.31: Using the catch handler on buggyCode ](Images/C14587_08_31.jpg)
...
10.  Modify error handling using `try`…`catch`:
    ...
    ![Figure 8.32: Modifying error handling using try…catch ](Images/C14587_08_32.jpg)
...
![Figure 8.33: Function returning a promise that resolves after n seconds ](Images/C14587_08_33.jpg)
...
![Figure 8.34: Running both wait functions using Promise.all ](Images/C14587_08_34.jpg)
...
![Figure 8.35: Running the buggyCode function after removing the await keyword ](Images/C14587_08_35.jpg)
...
5.  Run the `playPlaylist` function:
    ...
    ![Figure 8.36: Running the playPlaylist function ](Images/C14587_08_36.jpg)
...
6.  Call `playPlaylist` with no argument:
    ...
    ![Figure 8.37: Calling playPlaylist with no argument ](Images/C14587_08_37.jpg)
...
7.  Modify `playPlaylist` to handle errors:
    ...
    ![Figure 8.38: Modifying playPlaylist for error handling ](Images/C14587_08_38.jpg)
...
9.  Try to call a corrupted playlist:
    ...
    ![Figure 8.39: Calling a corrupted playlist ](Images/C14587_08_39.jpg)
...
10.  Modify `playPlaylist` to play songs sequentially:
    ...
    ![Figure 8.40: Modified playPlaylist to play songs sequentially ](Images/C14587_08_40.jpg)
...
11.  Modify `playSong` to suppress the `not found` error:
    ...
    ![Figure 8.41: Modified playSong to suppress the not found error ](Images/C14587_08_41.jpg)
...
11.  Call `calculateAll`.
    ...
    ![Figure 8.42: Calling the calculateAll function ](Images/C14587_08_42.jpg)
