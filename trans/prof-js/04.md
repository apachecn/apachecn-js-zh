...
![Figure 4.2: Showing localhost:3000 in the web browser ](Images/C14587_04_02.jpg)
...
![Figure 4.4: cURL piped to jq ](Images/C14587_04_04.jpg)
...
![Figure 4.5: Screenshot of the cURL request in Postman ](Images/C14587_04_05.jpg)
 ...
 *![Figure 4.6: Output message ](Images/C14587_04_06.jpg)
...
![Figure 4.7: Table of HTTP response code categories ](Images/C14587_04_07.jpg)
...
![Figure 4.8: Table of HTTP response codes ](Images/C14587_04_08.jpg)

###### 图 4.8:HTTP 响应代码表

在下图中，我们可以看到一些更具体的 HTTP 状态码:

![Figure 4.9: Table of HTTP response codes continued ](Images/C14587_04_09.jpg)
...
![Figure 4.10: Table of standard WoT routes ](Images/C14587_04_10.jpg)
...
![Figure 4.11: A tree chart of the smart-house API design ](Images/C14587_04_11.jpg)
...
![Figure 4.12: The cURL response for localhost:3000/devices/light ](Images/C14587_04_12.jpg)
...
5.  Make a `PUT` request to `/devices/light/actions/fade` with the incorrect value (`na`) to test the validation:
    ...
    ![Figure 4.14: The cURL error response for the /device/light/actions/fade route with incorrect data ](Images/C14587_04_14.jpg)
...
![Figure 4.15: The cURL response for the /device/light/actions/fade route with correct data ](Images/C14587_04_15.jpg)
...
6.  With the server running in one Terminal, open another to perform a few tests using `curl`. In the first command, we'll check that our new default endpoint is working and that our default value for the duration is used when no duration is provided:
    ...
    ![Figure 4.16: The cURL response for the /device/light route without a specified duration ](Images/C14587_04_16.jpg)
...
![Figure 4.17: The cURL response for the /device/light route with a specified duration ](Images/C14587_04_17.jpg)
...
![Figure 4.18: Diagram of middleware chaining ](Images/C14587_04_18.jpg)
...
9.  Open another Terminal window and run the following command to get a signed JWT token:
    ...
    ![Figure 4.19: Checking the value of $TOKEN in the Bash shell ](Images/C14587_04_19.jpg)
...
10.  Send a cURL request to `restricted-light`, with an authentication token, by running the following command in your Terminal:
    ...
    ![Figure 4.20: A successful cURL request to restricted-light using JWT ](Images/C14587_04_20.jpg)
...
11.  Send a `curl` request to `restricted-light`, without an authentication token, in your Terminal:
    ...
    ![Figure 4.21: Trying to cURL restricted-light without a JWT ](Images/C14587_04_21.jpg)
...
![Figure 4.22: Showing JWT.io with JWT data ](Images/C14587_04_22.jpg)
...
![Figure 4.23: JWT.io with a token that has a larger payload ](Images/C14587_04_23.jpg)
