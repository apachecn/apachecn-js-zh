...
![Converting Express.js routes to a functional reactive pattern](../images/00118.jpeg)
...
![Testing the widget](../images/00119.jpeg)

要测试公司建议下拉菜单，在**公司**字段中输入`a`，您将看到以下输出:

![Testing the widget](../images/00120.jpeg)
