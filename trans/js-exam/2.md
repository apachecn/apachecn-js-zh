...
正如本章名称所示，我们将在本章中构建一个有趣的应用——一个**Meme Creator**。 每个人都喜欢迷因! 但这并不是我们创建 Meme Creator 的唯一原因。 我们将探索一些新事物，它们将改变你构建 web 应用的方式。 让我们看看有什么准备:
...
在我们的`general.js`文件中，包括以下一行来导入所有的引导 JavaScript 文件到我们的 web 应用:
