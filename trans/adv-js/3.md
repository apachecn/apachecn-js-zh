...
![Figure 3.1: DOM tree structure ](image/Figure_3.1.jpg)
...
![Figure 3.2: My header link output ](image/Figure_3.2.jpg)
...
![Figure 3.3: Methods and syntax  ](image/Figure_3.3.jpg)
...
![Figure 3.4: DOM tree navigation properties](image/Figure_3.4.jpg)
...
`referenceNode`不是可选参数。 您必须显式地传入一个节点或值为空。 不同的浏览器和浏览器版本对无效值的解释不同，应用程序的功能可能会受到损害。
...
![Figure 3.5: Helper functions ](image/Figure_3.5.jpg)
...
6.  Append the table row stored in `row` as a child to the table stored in `table`. The output is shown in the following figure:
    ...
    ![Figure 3.6: Step 4 output](image/Figure_3.6.jpg)
...
![Figure 3.7: Final output ](image/Figure_3.7.jpg)
...
###### ![Figure 3.8: Step 2 Click me! button ](image/Figure_3.8.png)

###### 图 3.8:步骤 2 点击我! 按钮

![Figure 3.9: Output view ](image/Figure_3.9.jpg)
...
2.  In the HTML `body`, in the `userInteractionHolder` `div`, add a text input and a button.
    ...
    ![Figure 3.10: Output After stpe 2](image/Figure_3.10.jpg)
...
![Figure 3.11: Final output](image/Figure_3.11.jpg)
...
要使用 JQuery 构建一个功能强大的应用程序，执行以下步骤:
...
![Figure 3.12: After step 4 output](image/Figure_3.12.jpg)

###### 图 3.12:步骤 4 输出后

![Figure 3.13: After step 6 output ](image/Figure_3.13.jpg)
