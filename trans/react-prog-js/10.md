# 第十章。用 JavaScript 演示功能反应式编程:一个真实的例子第三部分——日历
...
![Play it again Sam – an interesting challenge](graphics/B04108_10_01.jpg)
...
![Play it again Sam – an interesting challenge](graphics/B04108_10_02.jpg)

渐进式公开为重复日历条目保留了更详细的支持项目组合，如果用户选择查看它们，则增加了显示重复日历条目的控件。

以下是循环日历条目的更高级界面的屏幕截图。因为有几种不同的方式来组织重复出现的日历条目，所以有几种控件可用。

![Play it again Sam – an interesting challenge](graphics/B04108_10_03.jpg)
...
![Classical Hijaxing works well](graphics/B04108_10_07.jpg)
...
![Built with usability in mind, but there's still room to grow](graphics/B04108_10_04.jpg)
...
![Built with usability in mind, but there's still room to grow](graphics/B04108_10_05.jpg)
...
![Built with usability in mind, but there's still room to grow](graphics/B04108_10_09.jpg)
...
![Plain old JavaScript objects are all you need](graphics/B04108_10_08.jpg)
...
![Progressive disclosure that starts simply](graphics/B04108_10_09.jpg)
...
![The holidays that inspired this calendar](graphics/B04108_10_11.jpg)
