...
![Figure 2.1 – Sample Interactive coding using Dnotebook ](image/B17076_02_01.jpg)
...
![Figure 2.2 – Dnotebook home page ](image/B17076_02_02.jpg)
...
![Figure 2.3 – Empty code and Markdown cells in Dnotebook ](image/B17076_02_03.jpg)

图 2.3–Dnotebook 中的空代码和减价单元格

每个单元格都有编辑按钮，可以用于不同的目的，如下图所示:

![Figure 2.4 – Action buttons available in each cell ](image/B17076_02_04.jpg)
...
![Figure 2.5 – A code cell and executed output in Dnotebook ](image/B17076_02_05.jpg)
...
![Figure 2.6 – Opening a Markdown cell in Dnotebook ](image/B17076_02_06.jpg)

图 2.6–在 Dnotebook 中打开降价单元格

点击**文本**按钮，打开一个标记单元格，如下图所示:

![Figure 2.7 – Writing Markdown text in a Markdown cell ](image/B17076_02_07.jpg)

图 2.7–在标记单元格中写入标记文本

在这里，您可以编写任何带有标记的文本，当执行时，结果将被编译为文本，并显示在标记单元格的位置，如下所示:

![Figure 2.8 – Output of a Markdown cell ](image/B17076_02_08.jpg)
...
1.  Create a new cell in your open notebook and add the following code:
    ...
    ![Figure 2.9 – Simple code to add two numbers ](image/B17076_02_09.jpg)
...
![Figure 2.10 – Two code cells sharing a persistent state ](image/B17076_02_10.jpg)
...
![Figure 2.11 – Making a plot with an external package  ](image/B17076_02_11.jpg)
...
![Figure 2.12 – Loading and displaying a CSV file  ](image/B17076_02_12.jpg)
...
![Figure 2.13 – Plotting a DataFrame ](image/B17076_02_13.jpg)
...
![Figure 2.14 – Comparing the for and forlog methods  ](image/B17076_02_14.jpg)
...
![Fig 2.15 – Writing simple text in a Markdown cell ](image/B17076_02_15.jpg)
...
![Fig 2.16 – Adding images ](image/B17076_02_16.jpg)
...
![Fig 2.17 – Markdown image result ](image/B17076_02_17.jpg)
...
![Fig 2.18 – Adding header text ](image/B17076_02_18.jpg)
...
![Fig 2.19 – List ](image/B17076_02_19.jpg)
...
![Fig 2.20 – Saving and importing a notebook ](image/B17076_02_20.jpg)
