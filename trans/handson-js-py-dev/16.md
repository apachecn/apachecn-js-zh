...
![](assets/321bf6f9-5ab4-4f32-80a8-923a814c5cbd.png)
...
注意，我们在这里使用`--save-dev`是因为我们不需要将 webpack 构建到我们的生产级文件中。 通过使用开发依赖，我们可以帮助减小包的大小，如果包膨胀，这个因素会减慢应用程序的速度。
...
![](assets/545d6bee-e61b-4a14-9ece-2c6a2a77a748.png)
